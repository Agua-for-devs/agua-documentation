...
### **4.2.** Create a _Text_ inside of "menusearchtabletdiv2":

`menusearchtablettext2`

### **4.3.** Create a _Text_ inside of "menusearchtabletdiv3":

`menusearchtablettext2`

### **4.4.** Create an _Icon_ inside of "menusearchtabletdiv4":
...
### **5.1.** Set "menusearchtabletdiv1, menusearchtabletdiv2, menusearchtabletdiv3, and menusearchtabletdiv4" _Size_:
...
### 5.2. Set "menusearchtabletdiv1, menusearchtabletdiv2, menusearchtabletdiv3" _Margin_:
...
### 5.3. Set "menusearchtabletdiv4" _Margin_:
