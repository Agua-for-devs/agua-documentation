...
* Inside the Top-Down first row of buttons, choose the Left-to-right second one.
...
* Inside the Top-Down second row of buttons, choose the Left-to-right second one.
* The items are packed  to each other toward the center.
