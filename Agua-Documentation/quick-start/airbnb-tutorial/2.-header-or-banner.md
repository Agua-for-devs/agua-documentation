...
#### **A. \[Click]** **the Text box and start to \[type]:**

* Your will have to erase the default text: Type...
* You can use any kind of character.
* You cannot create line breaks with the enter \[key].
